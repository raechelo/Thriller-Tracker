...
describe('cleanMovies', () => {
  ...
  it('should return a clean version of a movie object', () => {
    const expected = [{ title: 'Black Panther', id: 2, synopsis: 'Amazing movie, watch it', rating: 8.1, releaseDate: '2-8-16', posterImage: 'https://image.tmdb.org/t/p/w185_and_h278_bestv2somelink' }];
